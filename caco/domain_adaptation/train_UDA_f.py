...
def train_caco(model, trainloader, targetloader, cfg):
    print('caco DA train_caco_ema feature queue 4758 v2-----------------------------------------------------------')
    print('for publish')
    print('Train CaCo with source and target domains')
    ...
    print(cfg.TRAIN.move_momentum)
    print(cfg.TRAIN.dict_len)

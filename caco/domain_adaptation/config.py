...
from rda.utils import project_root, project_root_ADVENT
...
cfg.DATA_LIST_SOURCE = str(project_root_ADVENT / 'advent/dataset/gta5_list/{}.txt')
cfg.DATA_LIST_TARGET = str(project_root_ADVENT / 'advent/dataset/cityscapes_list/{}.txt')
# Directories
...
cfg.TRAIN.INFO_TARGET = str(project_root_ADVENT / 'advent/dataset/cityscapes_list/info.json')
...
# Other params
cfg.TRAIN.move_momentum = 0.999
cfg.TRAIN.dict_len = 100
cfg.TRAIN.featurec = 0.01
cfg.TRAIN.ent_clamp = 0.1
cfg.TRAIN.MAX_ITERS = 250000
cfg.TRAIN.EARLY_STOP = 120000
cfg.TRAIN.SAVE_PRED_EVERY = 200
...
cfg.TEST.start_iter = 1000  # used in 'best' mode
...
cfg.TEST.INFO_TARGET = str(project_root_ADVENT / 'advent/dataset/cityscapes_list/info.json')
